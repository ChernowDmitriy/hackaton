...
incidents = incidents.rename(columns={'event': 'name', 'unom': 'unom_id', 'date': 'expected_date', 'length': 'expected_duration', 'sys': 'organization'})[['unom_id', 'name', 'expected_date', 'expected_duration', 'organization']]
...
capitals = capitals.rename(columns={'event': 'name', 'unom': 'unom_id', 'date': 'expected_date', 'length': 'expected_duration'})[['unom_id', 'name', 'expected_date', 'expected_duration']]
