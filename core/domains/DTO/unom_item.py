...
class ItemUnomSchemaOutput(BaseModel):
    ...
    total_area: typing.Optional[str]
    project_series: typing.Optional[str]
    ...
    total_area_of_residential_premises: typing.Optional[str]
    total_area_of_non_residential_premises: typing.Optional[str]
    number_of_entrances: typing.Optional[int]
    number_of_freight_elevators: typing.Optional[int]
    type_of_housing_stock: typing.Optional[str]
    a_sign_of_a_building_accident: typing.Optional[str]
    apartments_number: typing.Optional[str]
    materialRoof: typing.Optional[str]
    mcd_management_status: typing.Optional[str]
    appointment: typing.Optional[str]
    the_order_of_roof_cleaning: typing.Optional[str]
    construction_volume: typing.Optional[str]
    object_wear_and_tear: typing.Optional[str]
    reason_change_status: typing.Optional[str]
    parent_id: typing.Optional[int]
    year_reconstruction: typing.Optional[str]
